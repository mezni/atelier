...
from app.routers import moteur_router, marque_router, categorie_router, vehicule_router
...
app.include_router(vehicule_router, tags=["Vehicule"], prefix="/api/v1/vehicule")
